...
public class TriangleTest {
	...
	@Test(expected = IllegalArgumentException.class)
	public void testGetAreaNaNBase() {
		Triangle theTria = new Triangle(Double.NaN, 4, 5);
		
		double actArea = theTria.getArea();		
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testGetAreaNaNHypo() {
		Triangle theTria = new Triangle(3, 4, Double.NaN);
		
		double actArea = theTria.getArea();		
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testGetPerimeterNaNBase() {
		Triangle theTria = new Triangle(Double.NaN, 4, 5);
	...
	public void testGetPerimeterNaNHeight() {
		Triangle theTria = new Triangle(3, Double.NaN, 5);
		
		double actPerim = theTria.getPerimeter();			
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testGetPerimeterNaNHypo() {
		Triangle theTria = new Triangle(3, 4, Double.NaN);
